...
/**
 * Mensagem contextual — SDD-DSG-001, seções 6 e 8.3.
 * Cada variante deve ser acompanhada de título e texto explicativo:
 * o que ocorreu, qual o impacto e o que fazer a seguir.
 */
