...
| 5 | SDD-PNL-001 | Painel básico do trabalho | Especificação aprovada; plano em revisão | Work + Codex | SDD-EQP-001 |
...
| 02 — Clientes e trabalhos | Em andamento | Revisar e aprovar o plano restritivo da SDD-PNL-001 |
